...
test('Общий renderer код (src/ без тестов) < 34575 строк (сейчас ' + totalSrc + ')', function () {
  assert(totalSrc < 34575, totalSrc + " > 34575")  // v1.2.307: временно под диагностику замера углов аватара — вернуть 34550 после удаления
})
