...
test('Общий renderer код (src/ без тестов) < 34593 строк (сейчас ' + totalSrc + ')', function () {
  assert(totalSrc < 34593, totalSrc + " > 34593")  // v1.2.315-316: +логотипы ВК/МАКС (записи + ветки распознавания)
})
