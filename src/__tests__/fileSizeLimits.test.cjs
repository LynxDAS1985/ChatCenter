...
// v1.2.264→273: 33880→34160 (AddSourceModal/TabContextMenu/скрытие вкладок/имя веб-значка). v1.2.275: →34260 (аватарки). v1.2.276-294: →34490 (аватарки + кнопка-стекло + контейнеры API/Веб). v1.2.300-302: →34550 (единая верхняя панель + линейные значки в TabBar + 3-зонный прокручиваемый рейл в NativeSidebar; комментарии по правилу проекта не режем). v1.2.305→306: временно поднимали до 34565 под диагностический дамп DOM в webAvatarScript, диагностика удалена (v1.2.306) → вернули 34550.
test('Общий renderer код (src/ без тестов) < 34550 строк (сейчас ' + totalSrc + ')', function () {
  assert(totalSrc < 34550, totalSrc + " > 34550")
})
