...
test('Общий renderer код (src/ без тестов) < 34680 строк (сейчас ' + totalSrc + ')', function () {
  assert(totalSrc < 34680, totalSrc + " > 34680")  // v1.2.315-316: логотипы ВК/МАКС; v1.2.321: +пункт Ozon в каталоге; v1.2.330: +ozonNavigate.js; v1.2.333: логотип Ozon (ключ+ветка+импорт)
})
