...
;['aiHandlers.js', 'aiToolIpcHandlers.js', 'auditIpcHandlers.js', 'taskIpcHandlers.js', 'reminderIpcHandlers.js', 'notifHandlers.js', 'dockPinHandlers.js', 'dockPinState.js', 'mainIpcHandlers.js'].forEach(function(f) {
