...
// v0.88.x: UI и render-уровневые тесты вынесены в multiAccountUI.test.cjs
// (этот файл уже за лимитом 400 строк; v0.88.x профильные тесты живут в unreadAutoPrefetch.test.cjs).
