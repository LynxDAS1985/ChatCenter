...
import useChatListResize from './useChatListResize.js'
// v1.2.460: чистые расчёты переехали в общий код; их проверки — в
// src/__tests__/chatListWidth.vitest.js. Здесь осталось только перетаскивание.
import {
  chatListMaxPx, CHAT_LIST_DEFAULT_WIDTH, CHAT_LIST_MIN_WIDTH, CHAT_LIST_MAX_WIDTH,
