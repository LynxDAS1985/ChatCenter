// v0.91.24 Day 1: smoke-тесты VirtualMessageListV2 (Virtuoso-замена).
//
// Зеркальное покрытие старого VirtualMessageList.vitest.jsx + Virtuoso-специфика.
...
import VirtualMessageListV2 from './VirtualMessageListV2.jsx'
...
describe('VirtualMessageListV2 — smoke (Day 1)', () => {
