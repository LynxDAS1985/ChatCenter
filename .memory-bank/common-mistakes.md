...
## 🟢 РЕШЕНО v0.87.51 (заменяет предыдущую запись): stale groupedUnread при tg:chat-unread-sync
...
## 🔴 КРИТИЧЕСКОЕ: расхождение бейджей «список 16 / стрелка 28» (v0.87.46)
...
## 🔴 КРИТИЧЕСКОЕ: unreadCount из кэша `tg-cache.json` устаревает (v0.87.45)
