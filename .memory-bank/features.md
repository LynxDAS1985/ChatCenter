...
## Текущая версия: v0.87.61 (24 апреля 2026)

**Структура файла**: этот features.md содержит только **последние активные версии** (v0.87.40 → v0.87.61). Старое — в архиве:
...
### v0.87.61 — ДИАГНОСТИКА: bubble-в-столбик в группах + нет скролла после send (только логи)
...
**План расследования**:
1. Перезапустить приложение с v0.87.61
