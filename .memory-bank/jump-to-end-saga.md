# Сага «jump-to-end-of-chat» (v0.95.11 — v0.95.20) — ✅ ЗАКРЫТА (29 мая 2026)
...
**Подтверждено юзером** (29 мая 2026): на реальной сессии после v0.95.20 — клик ↓ работает как ожидалось, эффекта «появления сообщений после скролла» больше нет. Сага закрыта.
