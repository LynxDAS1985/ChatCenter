...
### ✅ TODO-scroll-jump (ЗАКРЫТО 20 июля 2026): скролл работает как надо
Пользователь подтвердил 20 июля 2026: чат при возврате во вкладку ведёт себя корректно, прыжка нет. Задача снята, расследование НЕ требуется, код скролла не трогать без явной новой просьбы. (Механику восстановления позиции см. в закрытой саге scroll-restore — `archive/native-scroll-restore-saga-CLOSED.md`.)
...
| 2026-07-20 | v1.2.79 | TODO-scroll-jump — скролл работает как надо (подтв. юзером) | ✅ закрыто |
