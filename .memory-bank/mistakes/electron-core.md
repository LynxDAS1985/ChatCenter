...
**Урок**: если приложение САМО что-то отключает у сайта (SW, уведомления, storage) — ожидаемый отказ этого нельзя тащить в журнал как «ошибку». Иначе диагностический шум маскирует настоящие ошибки. Фильтровать самоинициированные отказы у источника.
