# Ловушки: кастомные уведомления (Messenger Ribbon) — ИСТОРИЯ (v1.2.7 и старше)

> Вынесено из `notifications-ribbon.md` в v1.2.78 (Совет 3, разгрузка файла у лимита 200 КБ).
> Все ловушки ниже РЕШЕНЫ. Свежие ловушки (v1.2.x) — в основном файле.
