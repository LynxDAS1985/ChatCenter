...
```
## 2026-06-29 — контроль после v1.2.27: title-фантомы MAX стали тише (архив)

Полная запись перенесена в [../archive/2026-06-notifications-ribbon-max-title-control.md](../archive/2026-06-notifications-ribbon-max-title-control.md). Активный вывод: v1.2.27 помогла против фантомов от `title/unread`; отдельная старая проблема исходящих через `__CC_NOTIF__` не была тем же багом и требует отдельного факта направления сообщения.
