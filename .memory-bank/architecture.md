...
┌──────────────────▼──────────────────────────────────┐
│                 Renderer Process                    │
│  src/ — UI приложения (React + Tailwind)            │
│  ├── App.jsx (2625 строк — главный компонент)       │
│  ├── components/                                     │
│  │   ├── MessengerTab.jsx (вкладка мессенджера)     │
│  │   ├── NotifLogModal.jsx (диагностика и логи)     │
│  │   ├── AISidebar.jsx (панель ИИ-помощника)        │
