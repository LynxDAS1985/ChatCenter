# Архив: журнал расследования тем форума Telegram

Вынесено из [`../group-topic-investigation.md`](../group-topic-investigation.md) 2026-09-16
(v1.2.468): активный файл дорос до 96 КБ при пределе 100 КБ.

Здесь — **хронология по дням** (май 2026): найденные проблемы счётчика непрочитанных в темах
форума, принятые по ходу решения, протоколы реализации.
Постановка задачи, факты Telegram API, корень и план решения остались в активном файле —
