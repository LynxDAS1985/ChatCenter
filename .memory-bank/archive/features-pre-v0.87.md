# Архив: features v0.1.0 – v0.86.10 (до native-режима)

**Заархивировано**: 24 апреля 2026 (v0.87.58).
**Источник**: `.memory-bank/features.md` строки 1798–3371.
**Период**: вся история от инициализации проекта (3 марта 2026) до Ловушки 64 (Telegram чёрный экран, v0.86.10, 14 апреля 2026). До запуска нативного режима.
