# Changelog ChatCenter — архив v0.87.51 – v0.87.64

**Архив создан**: 24 апреля 2026 (в составе v0.87.75 при разбиении `features.md` для удержания лимита 100 КБ).

**Что внутри**: версии v0.87.51 – v0.87.64. Включает:
- Прогрессию счётчика unread (v0.87.51-54)
- Диагностику send-message + FLOOD_WAIT throttle (v0.87.55)
- Рефакторинг Memory Bank: разбиение common-mistakes.md (v0.87.56)
- Внедрение промта правил работы в CLAUDE.md (v0.87.57)
- emit tg:new-message для исходящих (v0.87.58)
- Автотест лимитов памяти + check-memory (v0.87.59)
- Pre-commit hook + dangling-refs (v0.87.60)
- Рефакторинг CLAUDE.md (v0.87.61)
- Синхронизация workflow.md (v0.87.62)
- UI: bubble content-size до 75% (v0.87.64)

**Связано**:
- Предыдущий архив: [`features-v0.87.40-50.md`](./features-v0.87.40-50.md) — версии v0.87.40-50
- Активный changelog: [`../features.md`](../features.md) — версии v0.87.65 и новее
