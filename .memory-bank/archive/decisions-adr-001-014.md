# decisions.md — архив: ADR-001 … ADR-014 (фундамент, март–апрель 2026)

Перенесено из `decisions.md` 2026-07-31 (разгрузка под лимит 100 КБ). Стабильные фундаментальные решения раннего периода. Ссылки [[ADR-0NN]] из активного decisions.md на эти номера ведут сюда.
