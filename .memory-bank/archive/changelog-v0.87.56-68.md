# Архив: CHANGELOG.md записи v0.87.56 — v0.87.68 (2026-04-24)

Заархивировано 15 мая 2026 при релизе v0.89.8 (CHANGELOG.md превысил 100 КБ лимит после серии audit-релизов v0.89.2/3/4/5/6/7/8).

Содержание — записи Memory Bank infrastructure: введение file size limits (v0.87.68), архивация ранних versions of common-mistakes, pre-commit hooks, разбиение features.md, и т.п.
