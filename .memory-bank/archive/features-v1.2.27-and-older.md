# Архив features: v1.2.27 и старше

Дата архивации: 30 июня 2026.
Причина: активный features.md должен оставаться компактным, а текущая работа ведётся в последних версиях.
