# Changelog ChatCenter — архив v0.87.65 – v0.87.79

**Архив создан**: 27 апреля 2026 (в составе v0.87.92).
**Что внутри**: версии v0.87.65 – v0.87.79.
**Связано**:
- Предыдущий архив: [features-v0.87.51-64.md](./features-v0.87.51-64.md)
- Активный changelog: [../features.md](../features.md) — версии v0.87.80 и новее
