> ✅ **STATUS: CLOSED 9 июня 2026 по решению юзера**
> Юзер сказал «забудь про эту проблему, пометь как решена».
> Файл заархивирован. **НЕ ОТКРЫВАТЬ** этот файл по своей инициативе.
> Открывать ТОЛЬКО если юзер явно попросит «вернуться к скролл-проблеме».
>
> ---
