...
## ⚠️ Историческое примечание

Phase 0 + Phase 1 **выполнены в v0.97.0** (commit `ce994ce`, 2026-06-08).
Все 14 milestones (M0.1-M0.5 + M1.1-M1.9) done. Версия bump v0.95.50 → v0.97.0
(не v0.96.0 как изначально планировалось — Phase 0+1 смержены в один релиз
по запросу юзера «делай без остановки»).

Текущий чекпойнт: **ожидание команды «делай Phase 2»** от юзера.
См. [progress.md](./progress.md) для детального статуса.
