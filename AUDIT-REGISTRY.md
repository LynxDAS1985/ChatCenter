...
- `main/main.js`: `575` lines
- `src/App.jsx`: `566` lines
- `src/utils/webviewSetup.js`: `574` lines
- `main/preloads/monitor.preload.cjs`: `474` lines
- `main/handlers/dockPinHandlers.js`: `571` lines
- `src/components/AISidebar.jsx`: `542` lines
- preload `.cjs` files: `5`
- preload hook `.js` files: `4`
- main HTML files: `4`
- React component `.jsx` files: `13`
- `src/hooks/*.js`: `9`
- `src/utils/*.js`: `13`
- `src/__tests__/*.cjs`: `24`
- `e2e/*.cjs`: `2`
- `.memory-bank/*.md`: `12`
- `DOCS` folders: `15`
- `ipcMain.handle`: `24`
